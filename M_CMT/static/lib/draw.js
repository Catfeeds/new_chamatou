function turntableDraw(obj,jsn)
{
  ...
  var _this = this;
  var _addJiaodu = (_jiaodu/2);
  for(var i=1;i<=jsn.share;i++)
  {
    _str+="."+this.draw.newClass+i+"{";
    _str+="transform:rotate("+((i-1)*_jiaodu+_yuan+(_addJiaodu))+"deg);";
    _str+="-ms-transform:rotate("+((i-1)*_jiaodu+_yuan+(_addJiaodu))+"deg);";
    _str+="-moz-transform:rotate("+((i-1)*_jiaodu+_yuan+(_addJiaodu))+"deg);";
    _str+="-webkit-transform:rotate("+((i-1)*_jiaodu+_yuan+(_addJiaodu))+"deg);";
    _str+="-o-transform:rotate("+((i-1)*_jiaodu+_yuan+(_addJiaodu))+"deg);";
    ...
    _str+="transform:rotate("+((i-1)*_jiaodu+(_addJiaodu))+"deg);";
    _str+="-ms-transform:rotate("+((i-1)*_jiaodu+(_addJiaodu))+"deg);";
    _str+="-moz-transform:rotate("+((i-1)*_jiaodu+(_addJiaodu))+"deg);";
    _str+="-webkit-transform:rotate("+((i-1)*_jiaodu+(_addJiaodu))+"deg);";
    _str+="-o-transform:rotate("+((i-1)*_jiaodu+(_addJiaodu))+"deg);";
    _str+="}";
  };
